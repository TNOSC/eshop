...
argument-hint: <MigrationName, PascalCase_With_Underscores — e.g. Add_Reviews>
---

Add a migration for `EShopWriteDbContext` and review what EF generated.
Full policy: `.claude/rules/migrations.md`.

`$ARGUMENTS` is the migration name. If absent, ask what changed and propose a name.
