...
/// <remarks>
/// <para>
/// This is the load-bearing piece behind <c>ApiEndpointExtensions.HasPermission(permission)</c>, which
/// is just <c>RequireAuthorization(policyNames: permission)</c>. Nothing registers a policy per
/// permission, so without this provider every such endpoint would throw at request time with "The
/// AuthorizationPolicy named ... was not found". Here an unrecognised name is turned into
