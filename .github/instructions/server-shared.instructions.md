---
description: "Server.Shared: the constants both halves of a contract must agree on — cache tags, permissions, roles"
applyTo: "src/server/Tnosc.EShop.Server.Shared/**"
---
...
Full policy: `authorization.instructions.md`.
...
Full policy: `cache-tags.instructions.md`.
