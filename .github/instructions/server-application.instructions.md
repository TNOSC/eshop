---
description: "Server.Application: orchestration only — commands, handlers, validators, DTOs, workflows and ports"
applyTo: "src/server/Tnosc.EShop.Server.Application/**"
---
...
see `server-shared.instructions.md`.
...
Command handlers are unit-tested with NSubstitute over the repository contract — see `tests.instructions.md`.
