---
description: "File header and layout, primary constructors, named arguments, one parameter per line past two, Async naming, error-code and ErrorType conventions"
applyTo: "**/*.cs"
---
