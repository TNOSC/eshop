---
description: "Server.Domain: aggregates, factories, strategies, value objects, domain events and repository contracts — every business decision lives here"
applyTo: "src/server/Tnosc.EShop.Server.Domain/**"
---
...
Unit-test every factory, entity transition, value object and strategy here — see `tests.instructions.md`.
