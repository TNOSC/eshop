---
description: "Central Package Management, justifying a new package, layer discipline for package references"
applyTo: "**/*.csproj,**/Directory.Packages.props,**/Directory.Build.props"
---
...
`<NoWarn>` at the project level — see `analyzer-suppressions.instructions.md`.
