---
description: "[DomainEventName] is an immutable wire contract; event payload shape, the outbox, at-least-once delivery and idempotency"
...
redelivery is skipped rather than applied twice. See `idempotency.instructions.md`. Hand-written
