...
**Arguments:** [optional: a specific rule ID or project to focus on, e.g. CA1852 or Server.Api]
...
If the user named a rule ID or project, narrow the focus to it.
...
4. **Suppress only as a last resort**, per `.github/instructions/analyzer-suppressions.instructions.md`: a narrow
