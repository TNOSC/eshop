...
{
    public async Task<ApiResult<BasketDto>> GetBasketAsync(CancellationToken cancellationToken)
    {
    ...
    public async Task<ApiResult<BasketDto>> AddItemAsync(
    ...
    public async Task<ApiResult<BasketDto>> ChangeItemQuantityAsync(
        Guid itemId,
    ...
    public async Task<ApiResult> RemoveItemAsync(Guid itemId, CancellationToken cancellationToken)
    {
    ...
    public async Task<ApiResult> ClearAsync(CancellationToken cancellationToken)
    {
        using HttpResponseMessage response = await httpClient.DeleteAsync(
            requestUri: ApiRoutes.Basket.Current,
            cancellationToken: cancellationToken);
