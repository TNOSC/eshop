...
[`.claude/rules/blazor-client-mvvm.md`](../../../../.claude/rules/blazor-client-mvvm.md) for the full
...
of the server's permission vocabulary (`.claude/rules/authorization.md`), used to hide/disable UI for
...
- [ ] Everything else — page/component/ViewModel/service split, `ComponentState`/`StatefulBoundary`,
      `ClientValidation` — follows `.claude/rules/blazor-client-mvvm.md`.
