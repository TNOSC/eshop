...
/// </summary>
internal sealed class AdminSetDefaultCustomerAddressCommandValidator : IValidator<AdminSetDefaultCustomerAddressCommand>
{
    /// <inheritdoc />
    public ValueTask<Result> ValidateAsync(AdminSetDefaultCustomerAddressCommand request, CancellationToken cancellationToken)
    {
        List<Error> errors = [];
